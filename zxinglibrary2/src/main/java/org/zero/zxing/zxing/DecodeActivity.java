...
import org.zero.zxing.base.BaseZxingActivity;
import org.zero.zxing.zxing.camera.CameraManager;
import org.zero.zxing.zxing.common.BitmapUtils;
import org.zero.zxing.zxing.decode.BitmapDecoder;
import org.zero.zxing.zxing.decode.CaptureActivityHandler;
import org.zero.zxing.zxing.view.ScannerView;
 ...
 */
public class DecodeActivity extends BaseZxingActivity implements
    ...
    public static Intent newIntent(Context packageContext) {
        Intent intent = new Intent(packageContext, DecodeActivity.class);
        return intent;
    }
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case PARSE_BARCODE_SUC: // 解析图片成功
                    DecodeActivity decodeActivity = (DecodeActivity) activityReference.get();
                ...
                case PARSE_BARCODE_FAIL:// 解析图片失败
                    decodeActivity = (DecodeActivity) activityReference.get();
                    if (decodeActivity != null) {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        toolbar = (Toolbar) findViewById(R.id.toolbar_zxing);
        toolbarTitle = (TextView) findViewById(R.id.toolbar_zxing_title);
...
//        findViewById(R.id.capture_button_cancel).setOnClickListener(this);
        ...
        toolbar.setNavigationIcon(R.drawable.zxing_back);
        ...
        toolbarTitle.setText(R.string.zxing_scan);
