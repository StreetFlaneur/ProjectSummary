...
package org.zero.zxing.zxing.decode;
...
import org.zero.zxing.zxing.view.ViewfinderResultPointCallback;
...
public final class CaptureFragmentHandler extends Handler {
	...
	private final DecodeFragment activity;
	...
	public CaptureFragmentHandler(DecodeFragment activity,
		...
		// 启动扫描线程
		decodeThread = new DecodeFragmentThread(activity, decodeFormats, baseHints,
